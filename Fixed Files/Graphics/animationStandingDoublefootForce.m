function GlobalSupportfoot = animationStandingDoublefootForce(stored,Nsteps,name,framerate,fRSamples,fLSamples,alpha)
    ...
    for i = 1:n        
        robot=robot_move(robot,qs(:,i));   
            for l=1:4
                subplot(2,2,l);
                cla;
                robot_drawDoubleForce(robot,fRSamples(:,i),fLSamples(:,i));
